...
const IconButtonWrapper = ({ className, children, badgeNumber = 0 }: Props) => {
  return (
    <div
      className={`${className} h-10 w-10 rounded-full shadow-md dark:bg-neutral-700 dark:bg-opacity-40 dark:hover:bg-opacity-80 bg-slate-200 bg-opacity-10 hover:bg-opacity-20 relative cursor-pointer`}
    >
